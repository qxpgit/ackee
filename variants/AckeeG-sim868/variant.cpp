 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 6         |                  |  PA12   | CPU_TX_GPS      | EIC/EXTINT[12]             No_ADC_Channel   *SERCOM2/PAD[0]  TCC2/WO[0]
 * | 7         |                  |  PA15   | NC              | EIC/EXTINT[15]             No_ADC_Channel   *SERCOM2/PAD[3]  TC3/WO[1]
 * | 8         |                  |  PA13   | CPU_RX_GPS      | EIC/EXTINT[13]             No_ADC_Channel   *SERCOM2/PAD[1]  TCC2/WO[1]  
 * | 9         |                  |  PA14   | NC              | EIC/EXTINT[14]             No_ADC_Channel   *SERCOM2/PAD[2]  TC3/WO[0]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
