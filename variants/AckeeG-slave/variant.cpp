 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 0          |                  |  PA16  | TX_CR95        | EIC/EXTINT[0]                  
 * | 1          |                  |  PA17  | RX_CR95    	  | EIC/EXTINT[1] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 2         |                  |  PA04   | MOSI_EXT0_16    | EIC/EXTINT[6]             ADC/AIN[4]  AC/AIN[0]  PTC/Y[4] *SERCOM0_ALT/PAD[2]  TCC0/WO[0]
 * | 3         |                  |  PA07   | MISO_EXT0_17    | EIC/EXTINT[4]             ADC/AIN[7]  AC/AIN[3]  PTC/Y[2] *SERCOM0_ALT/PAD[0]  TCC1/WO[1]
 * | 4         |                  |  PA05   | SCK_EXT0_18     | EIC/EXTINT[7]             ADC/AIN[5]  AC/AIN[1]  PTC/Y[5] *SERCOM0_ALT/PAD[3]  TCC0/WO[1]  
 * | 5         |                  |  PA06   | SS_A_EXT0_15    | EIC/EXTINT[5]             ADC/AIN[6]  AC/AIN[2]  PTC/Y[3] *SERCOM0_ALT/PAD[1]  TCC1/WO[0]				 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 6         |                  |  PA12   | NC              | EIC/EXTINT[12]             No_ADC_Channel   *SERCOM2/PAD[0]  TCC2/WO[0]
 * | 7         |                  |  PA15   | NC              | EIC/EXTINT[15]             No_ADC_Channel   *SERCOM2/PAD[3]  TC3/WO[1]
 * | 8         |                  |  PA13   | NC              | EIC/EXTINT[13]             No_ADC_Channel   *SERCOM2/PAD[1]  TCC2/WO[1]  
 * | 9         |                  |  PA14   | BUZZER          | EIC/EXTINT[14]             No_ADC_Channel   *SERCOM2/PAD[2]  TC3/WO[0]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
  { PORTA,  12, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TCC2_CH0, EXTERNAL_INT_12 }, // SERCOM2/PAD[0]
  { PORTA,  15, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TC3_CH1, EXTERNAL_INT_15 },  // SERCOM2/PAD[3] 
  { PORTA,  13, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TCC2_CH1, EXTERNAL_INT_13 }, // SERCOM2/PAD[1]
  { PORTA,  14, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TC3_CH0, EXTERNAL_INT_14 },  // SERCOM2/PAD[2]

 /* +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | Pin number | SPI2             |  PIN   | Label/Name      | Comments        SPI2_EXT1 J1
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 10         |                  |  PA22   | MOSI_CR95HF     | EIC/EXTINT[6]             No_ADC_Channel *SERCOM3/PAD[0]      TC4/WO[0]
 * | 11         |                  |  PA21   | MISO_CR95HF     | EIC/EXTINT[5]             No_ADC_Channel *SERCOM3_ALT/PAD[3]  TC7/WO[1]
 * | 12         |                  |  PA23   | SCK_CR95HF      | EIC/EXTINT[7]             No_ADC_Channel *SERCOM3/PAD[1]      TC4/WO[1]  
 * | 13         |                  |  PA20   | SS_A_CR95HF     | EIC/EXTINT[4]             No_ADC_Channel *SERCOM3_ALT/PAD[2]  TC7/WO[0]				 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
  ...
  { PORTA,  20, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TC7_CH0, EXTERNAL_INT_4 }, // SERCOM0_ALT/PAD[2]
	
/* +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | Pin number | SPI3-RADIO       |  PIN   | Label/Name      | Comments SPI FOR AT86RF212B
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 14         |                  |  PB12  | MOSI_AT86    | EIC/EXTINT[12] SERCOM4/PAD[0] *TC4/WO[0]  
 * | 15         |                  |  PB15  | MISO_AT86    | EIC/EXTINT[13] SERCOM4/PAD[3] *TC5/WO[1]  
 * | 16         |                  |  PB13  | SCK_AT86     | EIC/EXTINT[14] SERCOM4/PAD[1]  TC4/WO[1]  
 * | 17         |                  |  PB14  | SS__AT86    | EIC/EXTINT[15] SERCOM4/PAD[2]  TC5/WO[0] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 18         |                  |  PB30  | MOSI_EPROM      | EIC/EXTINT[14] SERCOM5_ALT/PAD[0] *TC4/WO[0] 
 * | 19         |                  |  PB23  | MISO_EPROM      | EIC/EXTINT[7] SERCOM5_ALT/PAD[3] *TC5/WO[1]  
 * | 20         |                  |  PB31  | SCK_EPROM       | EIC/EXTINT[15] SERCOM5_ALT/PAD[1]  TC4/WO[1]  
 * | 21         |                  |  PB22  | SS_A_EPROM      | EIC/EXTINT[6] SERCOM5_ALT/PAD[2]  TC5/WO[0]  // SS EEPROM
 * | 22         |                  |  PB11  | nc              | EIC/EXTINT[11] SS_alternative  TC5/WO[1]  // SS RTC
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 23         |                  |  PB05  | CURR_SENS1      | EXTINT[5] 
 * | 24         |                  |  PB06  | DRV0            | EXTINT[6] 
 * | 25         |                  |  PB07  | DRV1            | EXTINT[7] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | Pin number | Digital          |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 30         |                  |  PA18  | LORA_RST        | EXTINT[2] 
 * | 31         |                  |  PA19  | LORA_IRQ        | EXTINT[3] 
 * | 32         |                  |  PB02  | INPUT0          | EXTINT[2] 
 * | 33         |                  |  PB03  | INPUT1          | EXTINT[3] 
 * | 34         |                  |  PB04  | CURR_SENS0      | EXTINT[4] 
 * | 35         |                  |  PB09  | CS_DIS1         | EXTINT[8] 
 * | 36         |                  |  PB10  | SDA_BITBANG     | EXTINT[10] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 { PORTB, 9, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8 },
 ...
 * | Pin number | Digital          |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 38         |                  |  PA08  | EN_REF_GND      | NO_EXTINT 	 *ADC/AIN[16]    
 * | 39         |                  |  PA09  | REF_GND_BATT    | EXTINT[9] 	 *ADC/AIN[17]    
 * | 40         |                  |  PA10  | EN_PWR_EXT      | EXTINT[10] 	 *ADC/AIN[18]    
 * | 41         |                  |  PA11  | NC              | EXTINT[11] 	 *ADC/AIN[19]    
 * | 42         |                  |  PB01  | GNSS_EN         | EXTINT[1] 	 *ADC/AIN[9]    
 * | 43         |                  |  PB08  | CIS_DIS0        | EXTINT[9] 	 *ADC/AIN[3]    
 ...
 */	
  ...
  { PORTB, 8, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel3, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9 },  
