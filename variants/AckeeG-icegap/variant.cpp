/*
VARIANT PER BOARD ICEGAP SLAVE 
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 0          |                  |  PA16  | TX_WIFI        | EIC/EXTINT[0]                  
 * | 1          |                  |  PA17  | RX_WIFI    	  | EIC/EXTINT[1] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 6         |                  |  PA12   | SHT25_SDA       | EIC/EXTINT[12]             No_ADC_Channel   *SERCOM2/PAD[0]  TCC2/WO[0]
 * | 7         |                  |  PA15   | RST_ESP         | EIC/EXTINT[15]             No_ADC_Channel   *SERCOM2/PAD[3]  TC3/WO[1]
 * | 8         |                  |  PA13   | SHT25_SCL       | EIC/EXTINT[13]             No_ADC_Channel   *SERCOM2/PAD[1]  TCC2/WO[1]  
 * | 9         |                  |  PA14   | SPI_SSN_WIFI    | EIC/EXTINT[14]             No_ADC_Channel   *SERCOM2/PAD[2]  TC3/WO[0]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 10         |                  |  PA22   | MOSI_LORA     | EIC/EXTINT[6]             No_ADC_Channel *SERCOM3/PAD[0]      TC4/WO[0]
 * | 11         |                  |  PA21   | MISO_LORA     | EIC/EXTINT[5]             No_ADC_Channel *SERCOM3_ALT/PAD[3]  TC7/WO[1]
 * | 12         |                  |  PA23   | SCK_LORA      | EIC/EXTINT[7]             No_ADC_Channel *SERCOM3/PAD[1]      TC4/WO[1]  
 * | 13         |                  |  PA20   | SS_A_LORA     | EIC/EXTINT[4]             No_ADC_Channel *SERCOM3_ALT/PAD[2]  TC7/WO[0]				 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 14         |                  |  PB12  | MOSI_EPAPER     | EIC/EXTINT[12] SERCOM4/PAD[0] *TC4/WO[0]  
 * | 15         |                  |  PB15  | MISO_EPAPER     | EIC/EXTINT[13] SERCOM4/PAD[3] *TC5/WO[1]  
 * | 16         |                  |  PB13  | SCK_EPAPER      | EIC/EXTINT[14] SERCOM4/PAD[1]  TC4/WO[1]  
 * | 17         |                  |  PB14  | SS_EPAPER       | EIC/EXTINT[15] SERCOM4/PAD[2]  TC5/WO[0] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 18         |                  |  PB30  | EN_PWR_LORA     | EIC/EXTINT[14] SERCOM5_ALT/PAD[0] *TC4/WO[0] 
 * | 19         |                  |  PB23  | EPAPER_BUSY     | EIC/EXTINT[7] SERCOM5_ALT/PAD[3] *TC5/WO[1]  
 * | 20         |                  |  PB31  | EN_PWR_WIFI     | EIC/EXTINT[15] SERCOM5_ALT/PAD[1]  TC4/WO[1]  
 * | 21         |                  |  PB22  | EPAPER_RST      | EIC/EXTINT[6] SERCOM5_ALT/PAD[2]  TC5/WO[0]  // SS EEPROM
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 23         |                  |  PB05  | LORA_DIO2       | EXTINT[5] 
 * | 24         |                  |  PB06  | LORA_DIO3       | EXTINT[6] 
 * | 25         |                  |  PB07  | LORA_DIO4       | EXTINT[7] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | Pin number | Digital          |  PIN   | Label/Name      | Comments (* is for default peripheral in use)
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 26         |                  |  PB16  | LED0_AUX        | EXTINT[0] 
 * | 27         |                  |  PB17  | LED1_AUX 		  | EXTINT[1] 
 * | 28         |                  |  PA27  | LED0            | EXTINT[15] 
 * | 29         |                  |  PA28  | LED1            | EXTINT[8] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | 34         |                  |  PB04  | LORA_DIO1       | EXTINT[4] 
 * | 35         |                  |  PB09  | EN_ESP          | EXTINT[8] 
 * | 36         |                  |  PB10  | GPIO0_ESP       | EXTINT[10] 
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * | 42         |                  |  PB01  | DRDY0           | EXTINT[1] 	 *ADC/AIN[9]    
 * | 43         |                  |  PB08  | LORA_DIO5       | EXTINT[9] 	 *ADC/AIN[3]    
