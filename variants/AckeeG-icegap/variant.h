...
#define LED          (28ul)
#define LED1          (29ul)
#define LED0_AUX          (26ul)
#define LED1_AUX          (27ul)
...
#define EPAPER_BUSY (19u)
#define EPAPER_RST	(21u)
...
// VARIOUS PINS TO ENABLE PERIFERAL
#define EN_REF_GND	 (38ul) 
#define REF_GND_BATT (39ul)
#define EN_PWR_EXT	 (40ul)
#define EN_PWR_LORA  (18ul)
#define EN_PWR_WIFI  (20ul)
#define EN_ESP (35ul)
/*
 * Analog pins
 */
...
// sht25
#define SHT25_SDA       (8ul)
#define SHT25_SCL       (6ul)
...
#define PIN_WIRE_SCL         (6ul)
#define PIN_WIRE_SDA         (8ul)
